 ...
 */
//@formatter:off
@Component(name = "sgsTEIExporterComponent", factory = "PepperExporterComponentFactory")
//@formatter:on
public class sgsTEIExporter extends PepperExporterImpl implements PepperExporter {
	// =================================================== mandatory
	// ===================================================
	/**
	 ...
	 * module unique.
	 */
	public sgsTEIExporter() {
		super();
		setName("sgsTEIExporter");
	 ...
	 * In this dummy implementation an instance of {@link sgsTEIMapper} is
	 * created and its location to where the document-structure should be
	 * exported to is set.
	 */
	@Override
	public PepperMapper createPepperMapper(Identifier Identifier) {
		PepperMapper mapper = new sgsTEIMapper();
		mapper.setResourceURI(getIdentifier2ResourceTable().get(Identifier));
		return (mapper);
	}

	public static class sgsTEIMapper extends PepperMapperImpl {
		/**
