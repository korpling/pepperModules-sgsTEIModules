package org.corpus-tools.pepperModules-sgsTEIModules;
 ...
 * @author Martin Klotz
 */
@Component(name = "sgsTEIManipulatorComponent", factory = "PepperManipulatorComponentFactory")
public class sgsTEIManipulator extends PepperManipulatorImpl {
	// =================================================== mandatory
	// ===================================================
	/**
	 ...
	 * module unique.
	 */
	public sgsTEIManipulator() {
		super();
		setName("sgsTEIManipulator");
	...
	public PepperMapper createPepperMapper(Identifier Identifier) {
		sgsTEIMapper mapper = new sgsTEIMapper();
		return (mapper);
	}
	 ...
	 */
	public static class sgsTEIMapper extends PepperMapperImpl implements GraphTraverseHandler {
		/**
		...
		public DOCUMENT_STATUS mapSDocument() {
			...
			// depth-first order top down. The id 'sgsTEITraversal' is used for
			...
			getDocument().getDocumentGraph().traverse(roots, GRAPH_TRAVERSE_TYPE.TOP_DOWN_DEPTH_FIRST, "sgsTEITraversal", this);
