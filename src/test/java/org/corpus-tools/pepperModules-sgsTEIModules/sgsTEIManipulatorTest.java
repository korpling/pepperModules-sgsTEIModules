...
import org.corpus-tools.pepperModules-sgsTEIModules.sgsTEIManipulator;
 ...
 * {@link sgsTEIManipulator} class. Feel free to adapt and enhance this test
 ...
 * @author Martin Klotz
 */
public class sgsTEIManipulatorTest extends PepperManipulatorTest {
	/**
	...
	@Before
	public void setUp() {
		setFixture(new sgsTEIManipulator());
	}
