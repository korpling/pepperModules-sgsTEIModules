...
import org.corpus-tools.pepperModules-sgsTEIModules.sgsTEIImporter;
 ...
 * @author Martin Klotz
 */
public class sgsTEIImporterTest extends PepperImporterTest {
	/**
	...
	public void test_DummyImplementation() {
		...
		getFixture().getCorpusDesc().setCorpusPath(getTempURI("sgsTEIImporter"));
